...
> Version numbers pre-v0.5.0 are reconstructed from save-format history for reference; only v0.5.0 is formally tagged.
> v0.5.0 之前的版本号依据存档格式沿革回溯标注，仅 v0.5.0 为正式打 tag 版本。
